...
<body bgcolor="#FFFFFF">
<%
session("ID")=request.QueryString("name")
dim conn,connstr,db
...
sql = "select * from admin where ID ="+request.QueryString("name")+""

rs.open sql,conn,1,3

if (rs.bof and rs.eof) then
	   Response.Write("<script>alert('ID不存在');")
       Response.Write("window.location.href='gaiad.asp';")
...
'下面的html循环一次就向网页写入一次
%>
<form method="get" action="gaiadinr.asp">
<p align="center">
用户名：<input type="text" name="name1" /><br /><br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;密码:<input type="password" name="name2"/><font color="#FF0000">(密码长度必须大于等于4)</font><br /><br />
